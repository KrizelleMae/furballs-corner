                ...
                try{
                  ...
                  foreach($stmt as $row){
                   ?> 
                      ...
                      <h2 style="text-transform: capitalize;"> <?php echo ($row['product_name']);?></h2>
                        <div class="product-price">	
                            <span class="price" style="font-weight: 600;">
                                P <?php echo ($row['rate']);?>.00</span> <br/>
                                <small>Available: <?php echo ($row['quantity']);?></small>                  
                        </div><!-- /.product-price -->
                      </div><!-- /.product-info -->
                  </div><!-----END OF DETAILS---->

                    
                      <form name="cart" action="cart.php?action=add_cart" method="POST">
                        <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>" />
                        <button  id="product" style="align-items:center;" type="submit" class="btn addcart" name="add_to_cart">Add to bag</button>
                      </form>
