...
$sql = "SELECT product.product_id, product.product_name, product.product_image, product.product_desc,
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
	...
	$productImage = "<img class='img-round' src='assets/images/stock/".$row['product_image']."' style='height:50px; width:50px;'  />";
