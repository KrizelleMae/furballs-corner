...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productDesc == "") {
				$("#productDesc").after('<p class="text-danger">Product Description is required</p>');
			...
			if(productImage && productName && productDesc && quantity && rate  && categoryName && productStatus) {
			...
			return false;
		}); // end of  aubmit product form

	}); // end of  add product modal btn clicked
...
function editProduct(productId = null) {
	...
	if(productId) {
		...
		$.ajax({
			url: 'actions/fetchSelectedProduct.php',
			type: 'post',
			...
			// alert(response.product_image);
				...
				$("#getProductImage").attr('src', 'assets/images/stock/'+response.product_image);
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				// product description
				$("#editProductDesc").val(response.product_desc);
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(productDesc == "") {
						$("#editProductDesc").after('<p class="text-danger">Brand Name field is required</p>');
					...
					if(productName && productDesc && quantity && rate &&  categoryName && productStatus) {
						// submit loading button
					...
					if(productImage) {
						...
						$.ajax({
				          ...
				          // reload the manage student table
									...
									$.ajax({
										url: 'actions/fetchProductImageUrl.php?i='+productId,
										type: 'post',
										success:function(response) {
		...
		}); // end of  ajax to fetch product image
...
function removeProduct(productId = null) {
	if(productId) {
		...
		$("#removeProductBtn").unbind('click').bind('click', function() {
			...
			}); // end of  ajax function to remove the product
			return false;
