...
function printOrder(orderId = null) {
	if(orderId) {		
		...
		$.ajax({
			url: 'actions/printOrder.php',
			type: 'post',
			data: {orderId: orderId},
			dataType: 'text',
			success:function(response) {
				
				var mywindow = window.open('', 'Furballs Corner', 'height=400,width=600');
...
function addRow() {
	...
	$.ajax({
		url: 'actions/fetchProductData.php',
		type: 'post',
		dataType: 'json',
		success:function(response) {
...
function paymentOrder(orderId = null) {
	if(orderId) {
		...
		$.ajax({
			url: 'actions/fetchOrderData.php',
			type: 'post',
			data: {orderId: orderId},
			dataType: 'json',
			success:function(response) {				
